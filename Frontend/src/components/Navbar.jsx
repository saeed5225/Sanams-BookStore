...
export default function Navbar() {
  ...
  return (
    <div
      className={`w-full fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white durartion-300 ${
        sticky
          ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:border-b dark:text-white duration-300 transition-all ease-in-out"
          : ""
      }`}
    >
      <div className="navbar max-w-screen-2xl container mx-auto md:px-20 px-4">
        <div className="navbar-start">
          ...
          <a
            href="/"
            className="cursor-pointer text-2xl font-extrabold font-serif"
          >
            Book Store
          </a>
        </div>
